-- Test Data for Scholarship Tracker Database
...
-- DELETE FROM user_search_preferences;
-- DELETE FROM users;
...
('Arts Achievement Award', 'Supporting talented students in the arts and humanities.', 'Creative Arts Society', 'Merit', 5000.00, 5000.00, '2024-04-15', 'Portfolio submission required', 'https://creativearts.org/achievement-award', 'https://creativearts.org/achievement-award', 'Creative Arts Society', TRUE, NOW(), NOW()),
('Future Leaders Scholarship', 'Supporting the next generation of leaders in business and technology.', 'Leadership Foundation', 'Merit', 15000.00, 15000.00, '2024-06-01', 'Leadership experience, minimum 3.5 GPA', 'https://leadershipfoundation.org/future-leaders', 'https://leadershipfoundation.org/future-leaders', 'Leadership Foundation', TRUE, NOW(), NOW()),
...
UNION ALL
SELECT 'User Search Preferences', COUNT(*) FROM user_search_preferences
UNION ALL
SELECT 'Recommenders', COUNT(*) FROM recommenders
UNION ALL
