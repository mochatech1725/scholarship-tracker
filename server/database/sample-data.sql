...
INSERT INTO scholarships (title, description, organization, target_type, min_award, max_award, deadline, eligibility, apply_url, url, source, active, created_at, updated_at) VALUES
('STEM Excellence Scholarship', 'Awarded to outstanding students pursuing degrees in STEM fields.', 'Tech Foundation', 'Merit', 10000.00, 10000.00, 'May 1, 2024', 'STEM major, minimum 3.8 GPA', 'https://techfoundation.org/scholarships/stem-excellence', 'https://techfoundation.org/scholarships/stem-excellence', 'Tech Foundation', TRUE, NOW(), NOW()),
('Arts Achievement Award', 'Supporting talented students in the arts and humanities.', 'Creative Arts Society', 'Merit', 5000.00, 5000.00, 'April 15, 2024', 'Portfolio submission required', 'https://creativearts.org/achievement-award', 'https://creativearts.org/achievement-award', 'Creative Arts Society', TRUE, NOW(), NOW()),
('Future Leaders Scholarship', 'Supporting the next generation of leaders in business and technology.', 'Leadership Foundation', 'Merit', 15000.00, 15000.00, 'June 1, 2024', 'Leadership experience, minimum 3.5 GPA', 'https://leadershipfoundation.org/future-leaders', 'https://leadershipfoundation.org/future-leaders', 'Leadership Foundation', TRUE, NOW(), NOW()),
('Community Service Award', 'Recognizing students who have made significant contributions to their communities.', 'Service Foundation', 'Merit', 8000.00, 8000.00, 'July 15, 2024', 'Minimum 100 hours of community service', 'https://servicefoundation.org/community-award', 'https://servicefoundation.org/community-award', 'Service Foundation', TRUE, NOW(), NOW());
